      ...
      <section className="mx-auto max-w-6xl px-6 pb-24 pt-20">
        <div className="rounded-3xl border border-cyan-900/60 bg-gradient-to-br from-cyan-950/35 to-yellow-950/20 p-8 md:p-12">
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            <Link href="/accept-satgate-capabilities" className="inline-flex items-center justify-center gap-2 rounded-lg border border-gray-700 px-6 py-3 font-bold text-white transition hover:border-cyan-500">Accept SatGate capabilities</Link>
          </div>
        </div>
      </section>
    </main>
