      ...
      <section className="relative overflow-hidden border-b border-gray-900">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-24">
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <Link href="/blog/macaroon-tokens-vs-api-keys" className="inline-flex items-center justify-center gap-2 rounded-lg bg-white px-6 py-3 font-bold text-black transition hover:bg-gray-200">Macaroons vs API keys <ArrowRight size={18} /></Link>
