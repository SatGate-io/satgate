              ...
              {currentScene === 'intro' && (
                <>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white">Default Protection</h2>
                      <p className="text-gray-400 text-sm">Layer 0 — Always-On Cryptographic Verification</p>
                    </div>
                  </div>
              ...
              {currentScene === 'summary' && (
                <>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white">Default Protection Demo Complete!</h2>
                      <p className="text-gray-400 text-sm">Layer 0 verified. Now choose your economic policy.</p>
                    </div>
                  </div>
                  <p className="text-gray-300 leading-relaxed">
  ...
  "code": "TOKEN_BANNED"
              ...
              {currentScene === 'summary' && (
                <div className="space-y-6">
                  ...
                  <div className="bg-gradient-to-r from-blue-950/30 to-cyan-950/30 rounded-xl p-4 border border-blue-800/30">
                    <h4 className="font-semibold text-white mb-3">What Default Protection Proves:</h4>
                    <ul className="text-gray-300 text-sm space-y-2">
                      ...
                      <li className="flex items-start gap-2">
                        <CheckCircle size={16} className="text-green-400 mt-0.5 flex-shrink-0" />
                        <span>Agents self-manage least-privilege access (no admin bottleneck)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle size={16} className="text-green-400 mt-0.5 flex-shrink-0" />
                      ...
                      <li className="flex items-start gap-2">
                        <CheckCircle size={16} className="text-green-400 mt-0.5 flex-shrink-0" />
                        <span>Google-grade macaroons — battle-tested since 2014</span>
                      </li>
                    </ul>
                  </div>
