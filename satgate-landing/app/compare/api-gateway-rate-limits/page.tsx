...
export const metadata = {
  ...
  description: 'Compare API Gateway rate limits with SatGate agent authority: delegated budgets, MCP tool policy, paid rails, revocation, hybrid controls, and Evidence Packs.',
  ...
  openGraph: { title: config.title, description: 'Compare API Gateway rate limits with SatGate agent authority: delegated budgets, MCP tool policy, paid rails, revocation, hybrid controls, and Evidence Packs.', url: 'https://satgate.io/compare/api-gateway-rate-limits', type: 'article' },
