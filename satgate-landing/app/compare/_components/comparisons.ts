...
export const brutalComparisons: Record<string, BrutalComparison> = {
  'aws-agentcore-payments': {
    ...
    description: 'AWS AgentCore Payments helps agents transact inside the AWS AgentCore ecosystem. SatGate governs whether agents are allowed to access, spend, delegate, call MCP tools, or use paid rails before execution across the messy multi-provider estate.',
    verdict: 'If your world is AWS AgentCore, AWS gives you managed payments. If your world is real enterprise sprawl — OpenAI, Anthropic, local agents, MCP tools, internal APIs, hybrid gateways, and multiple payment rails — SatGate is the control layer.',
    competitorGoodAt: [
    ...
    rows: [
      ...
      { axis: 'Cross-provider', satgate: standardAxes.crossProvider, competitor: 'Strongest when the buyer standardizes on AWS/Bedrock/AgentCore.', winner: 'SatGate' },
      ...
      { axis: 'Delegation', satgate: standardAxes.delegation, competitor: 'AWS identity and agent controls help inside AWS; portability across arbitrary agents and subagents is the hard part.', winner: 'SatGate' },
    ...
    bullets: [
      { title: 'AWS solves an AWS problem', body: 'That is valuable. It is also the limitation. Most enterprises will not put every agent, model, API, MCP server, and paid rail inside one AWS-native box.' },
    ...
    faqs: [
      ...
      { question: 'What is the brutal difference?', answer: 'AgentCore Payments helps an AWS agent pay. SatGate decides whether any agent is allowed to spend, access, delegate, or pay before execution.' },
  ...
  'langsmith-helicone-datadog': {
    ...
    bullets: [
      ...
      { title: 'Use both layers', body: 'Send traces to LangSmith, Helicone, or Datadog. Put SatGate in the path where the agent is about to spend.' },
    ],
    faqs: [
      ...
      { question: 'What is the brutal gap?', answer: 'Observability explains what happened. It usually does not provide portable delegated budgets, MCP tool enforcement, paid-rail governance, or pre-execution authority.' },
    ...
    ctaSecondary: { href: '/llm-cost-monitoring', label: 'From monitoring to control' },
  },
  'api-gateway-rate-limits': {
    ...
    rows: [
      ...
      { axis: 'Hybrid deployment', satgate: standardAxes.hybrid, competitor: 'Many gateway stacks can be hybrid. This is not the differentiator.', winner: 'Tie' },
    ...
    bullets: [
      ...
      { title: 'Logs are not proof', body: 'Access logs are raw exhaust. Evidence Packs are constructed around policy, authority, decision, and receipt.' },
    ],
    faqs: [
  ...
  'openai-anthropic-budget-controls': {
    ...
    bullets: [
      { title: 'Provider controls stop at the vendor boundary', body: 'The moment an agent leaves OpenAI or Anthropic for an MCP tool, SaaS API, database, or payment rail, native budgets lose the plot.' },
