...
export const metadata = {
  ...
  description: 'Compare SatGate and Langfuse. Langfuse is strong for LLM observability, traces, prompts, evaluations, and metrics; SatGate enforces budgets and authority before agents spend.',
