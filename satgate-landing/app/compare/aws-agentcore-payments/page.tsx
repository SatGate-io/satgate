...
export const metadata = {
  ...
  description: 'Compare SatGate and AWS AgentCore Payments across cross-provider control, paid rails, MCP gateway policy, delegated budgets, and Evidence Packs.',
  ...
  openGraph: { title: config.title, description: 'Compare SatGate and AWS AgentCore Payments across cross-provider control, paid rails, MCP gateway policy, delegated budgets, and Evidence Packs.', url: 'https://satgate.io/compare/aws-agentcore-payments', type: 'article' },
