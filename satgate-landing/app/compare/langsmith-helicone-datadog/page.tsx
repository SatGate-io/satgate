...
export const metadata = {
  ...
  description: 'Compare LLM observability tools with SatGate pre-execution control: delegated budgets, MCP gateway policy, paid rails, hybrid enforcement, and Evidence Packs.',
  ...
  openGraph: { title: config.title, description: 'Compare LLM observability tools with SatGate pre-execution control: delegated budgets, MCP gateway policy, paid rails, hybrid enforcement, and Evidence Packs.', url: 'https://satgate.io/compare/langsmith-helicone-datadog', type: 'article' },
