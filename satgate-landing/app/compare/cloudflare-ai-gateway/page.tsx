...
export const metadata = {
  ...
  description: 'Compare Cloudflare AI Gateway and SatGate across AI routing, rate limits, MCP gateway governance, pre-execution control, delegated budgets, and Evidence Packs.',
  ...
  openGraph: { title: config.title, description: 'Compare Cloudflare AI Gateway and SatGate across AI routing, rate limits, MCP gateway governance, pre-execution control, delegated budgets, and Evidence Packs.', url: 'https://satgate.io/compare/cloudflare-ai-gateway', type: 'article' },
