...
export const metadata = {
  ...
  description: 'Compare native OpenAI and Anthropic budget controls with SatGate cross-provider agent budgets, MCP gateway policy, paid rails, and Evidence Packs.',
  ...
  openGraph: { title: config.title, description: 'Compare native OpenAI and Anthropic budget controls with SatGate cross-provider agent budgets, MCP gateway policy, paid rails, and Evidence Packs.', url: 'https://satgate.io/compare/openai-anthropic-budget-controls', type: 'article' },
