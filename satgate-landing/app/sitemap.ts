...
const staticRoutes: SitemapEntry[] = [
  ...
  { path: '/agent-api-governance', lastModified: '2026-04-25', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/l402-agent-payments', lastModified: '2026-04-25', changeFrequency: 'weekly', priority: 0.9 },
  ...
  { path: '/compare', lastModified: '2026-04-12', changeFrequency: 'monthly', priority: 0.7 },
  ...
  { path: '/roi-calculator', lastModified: '2026-04-24', changeFrequency: 'monthly', priority: 0.8 },
...
const blogRoutes: SitemapEntry[] = [
  ...
  { path: '/blog/security-as-a-profit-center', lastModified: '2026-02-14', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/blog/ai-agent-api-cost-control', lastModified: '2026-04-24', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/blog/what-is-an-economic-firewall', lastModified: '2026-03-05', changeFrequency: 'monthly', priority: 0.7 },
  ...
  { path: '/blog/api-monetization-ai', lastModified: '2026-03-26', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/blog/why-process-wont-scale-for-ai-agent-costs', lastModified: '2026-03-28', changeFrequency: 'monthly', priority: 0.8 },
  ...
  { path: '/blog/l402-protocol-explained', lastModified: '2026-04-02', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/blog/zero-trust-for-ai-agents', lastModified: '2026-04-03', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/blog/start-at-1-credit-economic-policy', lastModified: '2026-04-07', changeFrequency: 'monthly', priority: 0.8 },
