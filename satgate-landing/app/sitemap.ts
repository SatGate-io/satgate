...
const staticRoutes: SitemapEntry[] = [
  ...
  { path: '/stripe-link-agents-vs-satgate', lastModified: '2026-05-01', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/agent-payment-controls', lastModified: '2026-05-01', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/http-402-for-ai-agents', lastModified: '2026-05-01', changeFrequency: 'weekly', priority: 0.9 },
  ...
  { path: '/mcp-cost-control', lastModified: '2026-04-27', changeFrequency: 'monthly', priority: 0.85 },
  { path: '/agent-api-governance', lastModified: '2026-04-26', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/agent-control-plane', lastModified: '2026-04-27', changeFrequency: 'weekly', priority: 0.9 },
  ...
  { path: '/pricing', lastModified: '2026-04-27', changeFrequency: 'monthly', priority: 0.9 },
  { path: '/security', lastModified: '2026-04-27', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/blog', lastModified: '2026-04-27', changeFrequency: 'weekly', priority: 0.8 },
  ...
  { path: '/protect', lastModified: '2026-04-27', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/pay', lastModified: '2026-04-27', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/mint-demo', lastModified: '2026-04-27', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/sandbox', lastModified: '2026-04-27', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/roi-calculator', lastModified: '2026-04-27', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/agent-api-key-risk-assessment', lastModified: '2026-04-27', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/agent-spend-policy-template', lastModified: '2026-04-27', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/revocable-capability-token-policy-template', lastModified: '2026-04-28', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/l402-api-pricing-calculator', lastModified: '2026-04-27', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/runaway-agent-cost-calculator', lastModified: '2026-04-27', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/openai-budget-policy-generator', lastModified: '2026-04-27', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/mcp-tool-cost-policy-generator', lastModified: '2026-04-27', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/mcp-proxy-config-generator', lastModified: '2026-04-27', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/economic-firewall-readiness-grader', lastModified: '2026-04-27', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/tools', lastModified: '2026-04-27', changeFrequency: 'weekly', priority: 0.8 },
  { path: '/seo-distribution-kit', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.5 },
  { path: '/design-partners', lastModified: '2026-04-27', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/agents', lastModified: '2026-04-27', changeFrequency: 'monthly', priority: 0.6 },
