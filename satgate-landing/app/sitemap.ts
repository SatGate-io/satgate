...
const staticRoutes: SitemapEntry[] = [
  ...
  { path: '/ai-api-budget-enforcement', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.85 },
  { path: '/agent-spending-limits', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.85 },
  { path: '/ai-agent-runaway-spend-benchmark', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.85 },
  { path: '/ai-agent-runaway-spend-index', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.85 },
  { path: '/mcp', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.8 },
  ...
  { path: '/mcp-cost-control', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.85 },
  ...
  { path: '/satgate-for-hermes-agent', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/integrations', lastModified: '2026-04-26', changeFrequency: 'weekly', priority: 0.8 },
  ...
  { path: '/compare/kong-ai-gateway', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/compare/apigee', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/compare/tyk', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/compare/langfuse', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.7 },
  ...
  { path: '/agent-api-key-risk-assessment', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/agent-spend-policy-template', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/l402-api-pricing-calculator', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.8 },
  ...
  { path: '/seo-distribution-kit', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.5 },
...
const blogRoutes: SitemapEntry[] = [
  ...
  { path: '/blog/api-gateway-for-ai-agents', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/blog/llm-cost-management', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.8 },
  ...
  { path: '/blog/macaroon-tokens-vs-api-keys', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/blog/http-402-payment-required-use-cases', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.8 },
  ...
  { path: '/blog/how-to-add-budget-limits-to-openai-api-calls', lastModified: '2026-04-26', changeFrequency: 'monthly', priority: 0.8 },
