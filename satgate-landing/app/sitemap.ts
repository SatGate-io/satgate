...
const staticRoutes: SitemapEntry[] = [
  ...
  { path: '/agent-payment-controls', lastModified: '2026-08-06', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/http-402-for-ai-agents', lastModified: '2026-08-06', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/ai-agent-cost-control', lastModified: '2026-08-06', changeFrequency: 'weekly', priority: 0.9 },
  ...
  { path: '/ai-agent-runaway-spend-benchmark', lastModified: '2026-08-06', changeFrequency: 'monthly', priority: 0.85 },
  { path: '/ai-agent-runaway-spend-index', lastModified: '2026-05-04', changeFrequency: 'monthly', priority: 0.85 },
  { path: '/mcp', lastModified: '2026-08-06', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/mcp-gateway', lastModified: '2026-08-06', changeFrequency: 'weekly', priority: 0.95 },
  { path: '/mcp-governance', lastModified: '2026-08-06', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/mcp-budget-enforcement', lastModified: '2026-08-06', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/mcp-cost-control', lastModified: '2026-08-06', changeFrequency: 'monthly', priority: 0.85 },
  { path: '/agent-api-governance', lastModified: '2026-08-06', changeFrequency: 'weekly', priority: 0.9 },
  ...
  { path: '/capability-auth', lastModified: '2026-08-06', changeFrequency: 'weekly', priority: 0.95 },
  { path: '/agent-control-plane', lastModified: '2026-08-06', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/evidence-pack-demo', lastModified: '2026-08-04', changeFrequency: 'weekly', priority: 0.95 },
  ...
  { path: '/agent-capability-tokens', lastModified: '2026-08-06', changeFrequency: 'weekly', priority: 0.9 },
  ...
  { path: '/satgate-for-openclaw', lastModified: '2026-05-04', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/satgate-for-hermes-agent', lastModified: '2026-05-04', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/integrations', lastModified: '2026-08-06', changeFrequency: 'weekly', priority: 0.8 },
  ...
  { path: '/roi-calculator', lastModified: '2026-08-06', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/agent-api-key-risk-assessment', lastModified: '2026-08-06', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/agent-spend-policy-template', lastModified: '2026-08-06', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/revocable-capability-token-policy-template', lastModified: '2026-08-06', changeFrequency: 'monthly', priority: 0.8 },
  ...
  { path: '/mcp-proxy-config-generator', lastModified: '2026-08-06', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/economic-firewall-readiness-grader', lastModified: '2026-08-05', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/tools', lastModified: '2026-08-06', changeFrequency: 'weekly', priority: 0.8 },
...
const blogRoutes: SitemapEntry[] = [
  ...
  { path: '/blog/ai-spend-governance', lastModified: '2026-08-06', changeFrequency: 'monthly', priority: 0.8 },
  ...
  { path: '/blog/how-we-built-budget-enforcement-mcp', lastModified: '2026-08-04', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/blog/hard-capping-mcp-tool-spend', lastModified: '2026-08-04', changeFrequency: 'monthly', priority: 0.6 },
  ...
  { path: '/blog/mcp-budget-enforcement-guide', lastModified: '2026-08-04', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/blog/agent-swarms-cost-governance', lastModified: '2026-05-04', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/blog/ai-agent-spending-limits', lastModified: '2026-08-04', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/blog/deepmind-intelligent-delegation-satgate', lastModified: '2026-05-04', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/blog/api-gateway-for-ai-agents', lastModified: '2026-08-05', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/blog/llm-cost-management', lastModified: '2026-08-06', changeFrequency: 'monthly', priority: 0.8 },
  ...
  { path: '/blog/api-monetization-ai', lastModified: '2026-08-06', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/blog/why-process-wont-scale-for-ai-agent-costs', lastModified: '2026-05-02', changeFrequency: 'monthly', priority: 0.8 },
  { path: '/blog/macaroon-tokens-vs-api-keys', lastModified: '2026-08-05', changeFrequency: 'monthly', priority: 0.8 },
