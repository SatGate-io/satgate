        ...
        <article className="prose prose-invert prose-lg max-w-none">
          ...
          <section className="not-prose mt-16 rounded-2xl border border-gray-800 bg-gray-950 p-8">
            ...
            <div className="space-y-5">
              {[
                ['What are Observe, Control, and Charge in AI agent governance?', 'Observe tracks agent usage and costs without blocking. Control enforces budgets and scoped policy for internal agents. Charge monetizes external agent access with paid-rail context.'],
