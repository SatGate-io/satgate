...
required_phrases = [
    "Every grant, paid call, denial, delegation, and revocation produces receipts",
...
govern_required_phrases = [
    ...
    "Observe agent activity, Control scopes, budgets, delegation, and revocation before execution",
    "Payment proves value moved; SatGate proves authority was evaluated.",
...
economic_required_phrases = [
    "Economic defense is the foundation",
    "Budget and authority limits",
    "Evidence capture",
    "External economic admission",
    ...
    "Payment does not grant permission outside policy.",
    "Proof across Observe, Control and Admit.",
    "A ledger debit is not external payment settlement.",
    "Map agent authority",
    "Enforce scoped authority",
    "Configure external admission",
    "Policy-to-Proof",
...
l402_rail_required_phrases = {
    ...
    "l402-agent-payments": [
        ...
        "applies Policy-to-Proof before execution",
